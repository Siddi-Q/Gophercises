...
// JSONHandler will parse the provided JSON and then return a http.HandlerFunc (which also implements http.Handler)
// that will attempt to map any paths to their corresponding URL
// If the path is not provided in the JSON, then the fallback http.Handler will be called instead.
//
// JSON is expected to be in the format:
//
// [{"path": "/some-path", "url": "https://www.some-url.com/demo"}]
//
// The only errors that can be returned are all related to having invalid JSON data.
